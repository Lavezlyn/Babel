...
try:
    from .api import api, vllm_api, generate_hash_uid
    API_AVAILABLE = True
except ImportError:
    API_AVAILABLE = False
    logging.warning("core.api not available, some backends may not work")
...
class OpenAIBackend(LLMBackend):
    ...
    def __init__(self,
        ...
        if not API_AVAILABLE:
            raise ImportError("core.api module required for OpenAIBackend")
...
class VLLMBackend(LLMBackend):
    ...
    def __init__(self,
        ...
        """
        if not API_AVAILABLE:
            raise ImportError("core.api module required for VLLMBackend")
...
# --- DeepSeek backend (lightweight wrapper) ---
class DeepSeekBackend(LLMBackend):
    ...
    def __init__(self,
        ...
        if not api_key:
            raise ImportError("DEEPSEEK_API_KEY environment variable or api_key arg required for DeepSeekBackend")
